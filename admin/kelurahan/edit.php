            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><?php echo isset($kelurahan) ? 'Edit Kelurahan' : 'Tambah Kelurahan'; ?></h1>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="id" value="<?= $_GET['id'] ?>">
                                        <input type="number" class="form-control" id="kec_id" name="kec_id" value="<?= $data['kec_id'] ?>" required>
                                    </div>
